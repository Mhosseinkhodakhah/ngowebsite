      ...
      <section className="flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col justify-center items-center my-10 max-w-screen-md">
          ...
          <ol class="space-y-6 list-decimal pr-5">
            ...
            <li class="text-gray-700">
              <span class="font-semibold bg-yellow-100 px-1 rounded">اطلاع‌رسانی در خصوص نقش سمن‌ها در کنوانسیون 2003:</span>
              افزایش آگاهی سمن‌ها در مورد اهمیت و نقش آن‌ها در اجرای کنوانسیون 2003 یونسکو،
              و ترویج بهترین شیوه‌های حفاظت از میراث فرهنگی ناملموس.
            </li>

            <li class="text-gray-700">
              <span class="font-semibold bg-yellow-100 px-1 rounded">ایجاد پایگاه داده از سمن‌ها:</span>
              شناسایی، مستندسازی و نقشه‌برداری از سازمان‌های مردم‌نهاد فعال در منطقه برای
              تسهیل ارتباطات، برنامه‌ریزی مشترک و تبادل اطلاعات.
            </li>

            <li class="text-gray-700">
              <span class="font-semibold bg-yellow-100 px-1 rounded">گسترش همکاری‌های بین‌المللی:</span>
              تقویت همکاری‌های فرامرزی میان سمن‌ها برای به اشتراک‌گذاری دانش، منابع
              و تجربیات، و ایجاد پل‌های فرهنگی برای تقویت هویت‌های بومی.
            </li>

            <li class="text-gray-700">
              <span class="font-semibold bg-yellow-100 px-1 rounded">پاسداری از میراث فرهنگی ناملموس:</span>
              حمایت از تلاش‌های منطقه‌ای برای حفظ و ترویج میراث فرهنگی ناملموس،
              با تأکید بر اهمیت این میراث در تقویت هویت فرهنگی.
            </li>

            <li class="text-gray-700">
              <span class="font-semibold bg-yellow-100 px-1 rounded">ظرفیت‌سازی و آموزش:</span>
              توانمندسازی سمن‌ها از طریق ارائه دوره‌های آموزشی، کارگاه‌های تخصصی و ارتقاء
              ظرفیت‌های بومی برای حفاظت مؤثر از میراث فرهنگی.
            </li>

            <li class="text-gray-700">
              <span class="font-semibold bg-yellow-100 px-1 rounded">ارتقاء آگاهی عمومی:</span>
              افزایش آگاهی عمومی در مورد اهمیت میراث فرهنگی ناملموس و نقش آن در توسعه پایدار
              جوامع محلی.
            </li>
