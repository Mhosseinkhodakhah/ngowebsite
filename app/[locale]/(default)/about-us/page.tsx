      ...
      <section className="flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col justify-center items-center my-10 max-w-screen-md">
          ...
          <ol className="font-light text-center text-justify leading-6 mt-4 px-2 max-w-3xl"
            ...
            >
            <li>
              <span class="highlight">تقویت و گسترش شبکه سمن‌های فعال:</span> ایجاد و تقویت شبکه‌ای گسترده از سازمان‌های مردم‌نهاد (NGOs) فعال
              در حوزه میراث فرهنگی ناملموس در آسیای غربی و مرکزی، به منظور تسهیل ارتباطات و اشتراک‌گذاری دانش و
              تجربیات.
            </li>

            <li>
              <span class="highlight">اطلاع‌رسانی در خصوص نقش سمن‌ها در کنوانسیون 2003:</span> افزایش آگاهی سمن‌ها در مورد اهمیت و نقش آن‌ها
              در اجرای کنوانسیون 2003 یونسکو، و ترویج بهترین شیوه‌های حفاظت از میراث فرهنگی ناملموس.
            </li>

            <li>
              <span class="highlight">ایجاد پایگاه داده از سمن‌ها:</span> شناسایی، مستندسازی و نقشه‌برداری از سازمان‌های مردم‌نهاد فعال در منطقه برای
              تسهیل ارتباطات، برنامه‌ریزی مشترک و تبادل اطلاعات.
            </li>

            <li>
              <span class="highlight">گسترش همکاری‌های بین‌المللی:</span> تقویت همکاری‌های فرامرزی میان سمن‌ها برای به اشتراک‌گذاری دانش، منابع
              و تجربیات، و ایجاد پل‌های فرهنگی برای تقویت هویت‌های بومی.
            </li>

            <li>
              <span class="highlight">پاسداری از میراث فرهنگی ناملموس:</span> حمایت از تلاش‌های منطقه‌ای برای حفظ و ترویج میراث فرهنگی ناملموس،
              با تأکید بر اهمیت این میراث در تقویت هویت فرهنگی.
            </li>

            <li>
              <span class="highlight">ظرفیت‌سازی و آموزش:</span> توانمندسازی سمن‌ها از طریق ارائه دوره‌های آموزشی، کارگاه‌های تخصصی و ارتقاء
              ظرفیت‌های بومی برای حفاظت مؤثر از میراث فرهنگی.
            </li>

            <li>
              <span class="highlight">ارتقاء آگاهی عمومی:</span> افزایش آگاهی عمومی در مورد اهمیت میراث فرهنگی ناملموس و نقش آن در توسعه پایدار
              جوامع محلی.
            </li>

            <li>
              <span class="highlight">ترویج تحقیقات و مستندسازی:</span> تقویت فعالیت‌های پژوهشی و مستندسازی به منظور انتقال بهتر دانش فرهنگی به
              نسل‌های آینده.
            </li>
          </ol>
