...
function SideBar() {
  ...
  return (
    <section
      className={`hidden md:flex md:w-2/5 lg:w-2/12 ${locale === "pe" ? "border" : "border-r"} border-dot flex-col justify-start light:bg-violet-100 rounded-e-2xl border-slate-300 dark:border-gray shadow-lg h-[98%]`}
    >
