      ...
      <div className="py-4 flex flex-col md:flex-row gap-10 md:gap-0 justify-around w-full">
        <div className="flex flex-col items-center">
          <div className="flex gap-2">
           ...
           <span className="text-sm font-light mt-4">{ data?.activityField }</span>
        </div>
        <div className="flex flex-col items-center">
          <div className="flex gap-2">
            <EmailIcon />
          ...
          <span className="text-sm font-light mt-4">{data?.nationalId}</span>
        </div>
        <div className="flex flex-col items-center ">
          <div className="flex gap-2">
            <EmailIcon />
          ...
          <span className="text-sm font-light mt-4">{data?.populationConcentration}</span>
        </div>
         <div className="flex flex-col items-center ">
          <div className="flex gap-2">
            <EmailIcon />
          ...
          <span className="text-sm font-light mt-4">{data?.specificActiveAreas}</span>
        </div>
      </div>
