      ...
      >
        {data?.mainImages?.map((image: string, index: number) => (
          ...
          >
            ...
            >
              <div className="bg-gray dark:bg-secondary backdrop-blur-md p-4 rounded-md flex justify-center items-center flex-col opacity-80 max-w-lg w-[90%] h-8 md:w-auto">
